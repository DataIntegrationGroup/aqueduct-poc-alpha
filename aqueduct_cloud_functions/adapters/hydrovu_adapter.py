...
Raw records come from GCS (written by the PVACD ingest Cloud Function).
...
Fetching and auth live in the HydroVu ingest function, not here.
"""
...
class HydroVuAdapter(BaseAdapter):
    """Maps raw HydroVu records staged in GCS to the canonical model."""

    def __init__(self) -> None:
        """Initialize the adapter with the PVACD agency code."""
